...
For TypeScript definitions in your project, inspect `node_modules/@hamr/coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@hamr/coding-agent";
