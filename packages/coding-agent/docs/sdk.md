...
The SDK provides programmatic access to pi's agent capabilities. Use it to embed hamr in other applications, build custom interfaces, or integrate with automated workflows.
...
```typescript
import { createAgentSession, SessionManager } from "@hamr/coding-agent";
...
import { AuthStorage, ModelRegistry } from "@hamr/coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@hamr/coding-agent";
...
```typescript
import { createAgentSession } from "@hamr/coding-agent";
...
import { createAgentSession, defineTool } from "@hamr/coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@hamr/coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@hamr/coding-agent";
