...
export class SettingsManager {
    constructor(storage, initialGlobal, initialProject, globalLoadError = null, projectLoadError = null, initialErrors = [], projectTrusted = true, defaultPackages = []) {
    ...
    static fromStorage(storage, options = {}) {
        ...
        return new SettingsManager(storage, globalLoad.settings, projectLoad.settings, globalLoad.error, projectLoad.error, initialErrors, projectTrusted, options.defaultPackages ?? []);
    }
    ...
    getClearOnShrink() {
        ...
        return (process.env.HAMR_CLEAR_ON_SHRINK || process.env.PI_CLEAR_ON_SHRINK) === "1";
    }
    ...
    getShowHardwareCursor() {
        return (this.settings.showHardwareCursor ??
            (process.env.HAMR_HARDWARE_CURSOR === "1" || process.env.PI_HARDWARE_CURSOR === "1"));
    }
