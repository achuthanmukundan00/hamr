...
import * as _bundledPiAgentCore from "@hamr/agent";
import * as _bundledPiAi from "@hamr/ai";
import * as _bundledPiAiOauth from "@hamr/ai/oauth";
import * as _bundledPiTui from "@hamr/tui";
...
// avoiding a circular dependency. Extensions can import from @hamr/coding-agent.
...
const VIRTUAL_MODULES = {
    ...
    "@hamr/agent": _bundledPiAgentCore,
    "@hamr/tui": _bundledPiTui,
    "@hamr/ai": _bundledPiAi,
    "@hamr/ai/oauth": _bundledPiAiOauth,
    "@hamr/coding-agent": _bundledPiCodingAgent,
...
function getAliases() {
    ...
    const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@hamr/agent");
    const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@hamr/tui");
    const piAiEntry = resolveWorkspaceOrImport("ai/dist/index.js", "@hamr/ai");
    const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@hamr/ai/oauth");
    _aliases = {
        "@hamr/coding-agent": piCodingAgentEntry,
        "@hamr/agent": piAgentCoreEntry,
        "@hamr/tui": piTuiEntry,
        "@hamr/ai": piAiEntry,
        "@hamr/ai/oauth": piAiOauthEntry,
...
function createExtensionAPI(extension, runtime, cwd, eventBus) {
    const api = {
        ...
        registerRoleMessageRenderer(role, renderer) {
            runtime.assertActive();
...
function resolveExtensionEntries(dir) {
    // Check for package.json with "hamr" field first
 ...
 * 3. Subdirectory with package.json: `extensions/* /package.json` with "hamr" field → load what it declares
 *
