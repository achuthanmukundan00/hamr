...
import { Container, getKeybindings, Input, matchesKey, Spacer, truncateToWidth, visibleWidth, } from "@hamr/tui";
...
function getGroupLabel(metadata) {
    ...
    if (metadata.source === "auto") {
        ...
        return metadata.scope === "user" ? "User (~/.hamr/agent/)" : "Project (.hamr/)";
    }
