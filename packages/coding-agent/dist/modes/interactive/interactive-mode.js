...
import { getProviders, } from "@hamr/ai";
import { CombinedAutocompleteProvider, Container, fuzzyFilter, getCapabilities, hyperlink, isKeyRelease, Loader, Markdown, matchesKey, ProcessTerminal, Spacer, setKeybindings, Text, TruncatedText, TUI, visibleWidth, } from "@hamr/tui";
...
import { getHamrUserAgent } from "../../utils/hamr-user-agent.js";
import { getCwdRelativePath } from "../../utils/paths.js";
import { killTrackedDetachedChildren } from "../../utils/shell.js";
import { ensureTool } from "../../utils/tools-manager.js";
import { checkForNewHamrVersion } from "../../utils/version-check.js";
...
export class InteractiveMode {
    ...
    async init() {
        ...
        if (this.options.verbose) {
            ...
            const compactOnboarding = theme.fg("dim", `Press ${keyText("app.tools.expand")} for full startup help and loaded resources.`);
            const onboarding = theme.fg("dim", `Hamr can explain its local tools, Relay setup, sessions, memory, and model compatibility.`);
    ...
    renderSplashScreen() {
        ...
        if (model) {
            ...
            const kv = (label, value, color = text) => {
    ...
    refreshSplashIfLive() {
        ...
        if (currentKey === this.splashRenderedModelKey)
            return;
    ...
    setHiddenThinkingLabel(label) {
        ...
        for (const child of this.chatContainer.children) {
            if ("setHiddenThinkingLabel" in child &&
                typeof child.setHiddenThinkingLabel === "function") {
     ...
     */
    registerGlobalInterruptListener() {
            ...
            case "message_start":
                if (event.message.role === "custom") {
                    ...
                    if (roleRenderer) {
                        ...
                        this.streamingComponent = new AssistantMessageComponent(undefined, this.hideThinkingBlock, this.getMarkdownThemeWithSettings(), this.hiddenThinkingLabel, modelAccent, modelGlyph);
                        this.chatContainer.addChild(this.streamingComponent);
        ...
        switch (message.role) {
                    ...
                    if (skillBlock) {
                        ...
                        if (skillBlock.userMessage) {
                            ...
                            if (roleRenderer) {
                                ...
                                const userComponent = new UserMessageComponent(skillBlock.userMessage, this.getMarkdownThemeWithSettings(), modelAccent, modelGlyph);
                        ...
                        if (roleRenderer) {
                            ...
                            const userComponent = new UserMessageComponent(textContent, this.getMarkdownThemeWithSettings(), modelAccent, modelGlyph);
                            this.chatContainer.addChild(userComponent);
                        }
                    }
            ...
            case "assistant": {
                ...
                if (roleRenderer) {
                    ...
                    const assistantComponent = new AssistantMessageComponent(message, this.hideThinkingBlock, this.getMarkdownThemeWithSettings(), this.hiddenThinkingLabel, modelAccent, modelGlyph);
    ...
    renderProjectTrustWarningIfNeeded() {
        ...
        this.chatContainer.addChild(new Text(theme.fg("warning", "This project is not trusted. Project .hamr resources and packages are ignored. Use /trust to save a trust decision, then restart hamr."), 1, 0));
        this.chatContainer.addChild(new Spacer(1));
    }
    async getUserInput() {
                ...
                onHideThinkingBlockChange: (hidden) => {
                    ...
                    for (const child of this.chatContainer.children) {
                        if ("setHideThinkingBlock" in child &&
                            typeof child.setHideThinkingBlock === "function") {
