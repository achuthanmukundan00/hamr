...
export function getPackageDir() {
    ...
    const envDir = process.env.HAMR_PACKAGE_DIR || process.env.PI_PACKAGE_DIR;
    if (envDir) {
...
export const PACKAGE_NAME = pkg.name || "@skaft/hamr";
export const APP_NAME = appConfigName || "hamr";
export const APP_TITLE = appConfigName ? APP_NAME : "hamr";
export const CONFIG_DIR_NAME = appConfig?.configDir || ".hamr";
export const VERSION = pkg.version || "0.0.0";
// e.g., PI_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;
export const ENV_SESSION_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_SESSION_DIR`;
const LEGACY_PI_ENV_AGENT_DIR = "PI_CODING_AGENT_DIR";
export function expandTildePath(path) {
    return normalizePath(path);
}
const DEFAULT_SHARE_VIEWER_URL = "https://hamr.dev/session/";
/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId) {
    const baseUrl = process.env.HAMR_SHARE_VIEWER_URL || process.env.PI_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
    return `${baseUrl}#${gistId}`;
}
// =============================================================================
// User Config Paths (~/.hamr/agent/*)
// =============================================================================
/** Get the agent config directory (e.g., ~/.hamr/agent/) */
export function getAgentDir() {
    const envDir = process.env[ENV_AGENT_DIR] || process.env[LEGACY_PI_ENV_AGENT_DIR];
    if (envDir) {
