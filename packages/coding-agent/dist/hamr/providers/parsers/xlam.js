...
function buildCall(name, obj, raw, index) {
    let args = {};
    ...
    return {
        id: generateCallId((obj.id ?? obj.call_id), index + 1),
        name,
        arguments: args,
        rawSource: raw,
        parserId: PARSER_ID,
...
// ─── Factory ──────────────────────────────────────────────
export function createXlamParser() {
    return xlamParser;
}
//# sourceMappingURL=xlam.js.map