 ...
 */
import { coerceValue, extractDelimitedBlocks, generateCallId, sanitizeReasoningTags } from "./utils.js";
const PARSER_ID = "qwen3_xml";
const DESCRIPTION = "Qwen3-Coder / Qwen3 XML format: <tool_call><function=name><parameter=key>value</parameter></function></tool_call>";
const FAMILIES = ["Qwen3", "Qwen3-Coder", "Qwen3.5", "Qwen3.6"];
export const qwen3XmlParser = {
    id: PARSER_ID,
...
// ─── Block parser ─────────────────────────────────────────
function parseQwenFunctionBlock(block, index) {
...
// ─── Factory ──────────────────────────────────────────────
export function createQwen3XmlParser() {
    return qwen3XmlParser;
}
//# sourceMappingURL=qwen3-xml.js.map