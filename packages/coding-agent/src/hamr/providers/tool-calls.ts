...
export { detectParserId, ensureParsersRegistered, toolCallParserRegistry } from "./parsers/index.ts";
export type { ParsedToolCall } from "./parsers/types.ts";
export { resetCallIdCounter, sanitizeReasoningTags } from "./parsers/utils.ts";
...
import { safeJsonParse, sanitizeReasoningTags as sanitizeReasoning } from "./parsers/utils.ts";
...
import { ensureParsersRegistered } from "./parsers/index.ts";
import { toolCallParserRegistry } from "./parsers/registry.ts";
