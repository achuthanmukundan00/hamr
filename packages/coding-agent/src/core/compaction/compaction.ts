...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@hamr/agent";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@hamr/ai";
import { completeSimple } from "@hamr/ai";
import {
	convertToLlm,
