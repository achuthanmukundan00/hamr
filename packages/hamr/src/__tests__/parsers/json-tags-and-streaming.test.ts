...
import { ensureParsersRegistered, resetCallIdCounter, toolCallParserRegistry } from "../../llm/parsers/index";
...
describe("Streaming chunk boundary simulation", () => {
	 ...
	 *
	 * In production, Hamr accumulates stream chunks and parses the complete
