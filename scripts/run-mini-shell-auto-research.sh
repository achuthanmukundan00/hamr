#!/usr/bin/env bash
# run-mini-shell-auto-research.sh — Convenience launcher for the Hamr auto-research loop.
#
# Runs the long-loop with Pi+DeepSeek improving Hamr, benchmarked against Gemma
...
#   HAMR_BENCH_THINKING     Benchmark thinking level (default: off)
...
BENCH_THINKING="${HAMR_BENCH_THINKING:-off}"
...
echo "═══════════════════════════════════════════════════════════════"
echo "  Hamr Auto-Research — mini-shell long loop"
echo "═══════════════════════════════════════════════════════════════"
echo ""
echo "  Benchmark subject:  Hamr + Gemma (thinking=${BENCH_THINKING})"
...
export HAMR_BENCH_THINKING="$BENCH_THINKING"
