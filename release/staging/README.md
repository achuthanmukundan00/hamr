...
Hamr began as Synax, an internal tool at Skaft. It was rebuilt on [pi](https://github.com/badlogic/lemmy) by Mario Zechner — chosen as the fork base for its terminal-first architecture and TUI renderer (`sexy-tui-rs`). The codebase has been heavily refactored into a 4-package TypeScript workspace with parallel subagent orchestration, an extension platform, and a modular provider layer. See [NOTICE.md](NOTICE.md) for full attribution.
