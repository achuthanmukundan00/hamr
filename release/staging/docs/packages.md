...
- [Creating a Hamr Package](#creating-a-hamr-package)
...
Hamr bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@hamr/ai`, `@hamr/agent`, `@skaft/hamr`, `@hamr/tui`, `typebox`.
