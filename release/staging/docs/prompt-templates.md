> hamr can create prompt templates. Ask it to build one for your workflow.
...
Hamr loads prompt templates from:

- Global: `~/.hamr/agent/prompts/*.md`
- Project: `.hamr/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `hamr.prompts` entries in `package.json`
