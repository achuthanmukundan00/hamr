import { ensureParsersRegistered, toolCallParserRegistry } from "./parsers/index.js";
import { sanitizeReasoningTags as sanitizeReasoning } from "./parsers/utils.js";
...
export { toolCallParserRegistry } from "./parsers/index.js";
 ...
 */
export function parseModelOutput(content, parserId, reasoningContent) {
    ensureReg();
    const warnings = [];
    ...
    if (parserResult.ok) {
        ...
        const tryParseRepaired = (pid, text) => {
            const key = `${pid}::${text}`;
