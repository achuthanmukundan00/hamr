 ...
 */
export function repairXml(raw) {
    const fixes = [];
    let working = raw.trim();
    if (!working)
        return null;
    if (!containsXmlTags(working))
        return null;
 ...
 */
function stripReasoningFromXml(text) {
    let cleaned = text;
 ...
 */
function balanceToolCallTags(text) {
 ...
 */
function balanceFunctionTags(text) {
 ...
 */
function balanceParameterTags(text) {
 ...
 */
function wrapBareFunctionNames(text) {
...
//# sourceMappingURL=xml-repair.js.map