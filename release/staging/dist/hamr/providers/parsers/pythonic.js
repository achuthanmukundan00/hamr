 ...
 */
import { generateCallId, parsePythonicArgs, sanitizeReasoningTags } from "./utils.js";
// ─── Shared parser logic ──────────────────────────────────
...
function parsePythonicCalls(text, parserId) {
...
export const llama4PythonicParser = {
    id: "llama4_pythonic",
...
// ─── Factories ────────────────────────────────────────────
export function createPythonicParser() {
    return pythonicParser;
}
export function createLlama4PythonicParser() {
    return llama4PythonicParser;
}
//# sourceMappingURL=pythonic.js.map