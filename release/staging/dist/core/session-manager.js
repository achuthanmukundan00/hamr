...
export function findMostRecentSession(sessionDir, cwd) {
    ...
    try {
        const files = readdirSync(resolvedSessionDir)
            ...
            .filter((file) => file.header !== null && (!resolvedCwd || sessionCwdMatches(getSessionHeaderCwd(file.header), resolvedCwd)))
...
export class SessionManager {
     ...
     */
    appendSpawnPoint(childSessionId, policy, childSessionPath, runId, taskPreview) {
        const entry = {
            type: "spawn_point",
            id: generateId(this.byId),
            parentId: this.leafId,
     ...
     */
    mergeHandoff(spawnPointEntryId, customType, content, details) {
     ...
     */
    getSpawnPoints() {
        return this.getEntries().filter((e) => e.type === "spawn_point");
    }
     ...
     * @param sessionDir Optional session directory. If omitted, uses default (~/.hamr/agent/sessions/<encoded-cwd>/).
     */
