...
export type SessionEntry = SessionMessageEntry | ThinkingLevelChangeEntry | ModelChangeEntry | CompactionEntry | BranchSummaryEntry | CustomEntry | CustomMessageEntry | LabelEntry | SessionInfoEntry | SpawnPointEntry;
...
export type ReadonlySessionManager = Pick<SessionManager, "getCwd" | "getSessionDir" | "getSessionId" | "getSessionFile" | "getLeafId" | "getLeafEntry" | "getEntry" | "getLabel" | "getBranch" | "getHeader" | "getEntries" | "getTree" | "getSessionName" | "getChildren" | "getSpawnPoints" | "appendSpawnPoint" | "mergeHandoff">;
...
export declare class SessionManager {
     ...
     */
    appendSpawnPoint(childSessionId: string, policy: SpawnPolicy, childSessionPath?: string, runId?: string, taskPreview?: string): string;
    /**
