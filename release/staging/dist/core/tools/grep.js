...
export function createGrepToolDefinition(cwd, options) {
    ...
    return {
        ...
        // Intentionally no promptSnippet: bash covers grep, so it's not advertised in the system prompt.
        ...
        renderCall(args, theme, context) {
            const text = context.lastComponent ?? new Text("", theme.cards.headingIndent, 0);
