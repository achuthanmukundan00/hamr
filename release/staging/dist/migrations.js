...
const MIGRATION_GUIDE_URL = "https://github.com/skaft-software/hamr/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/skaft-software/hamr/blob/main/packages/coding-agent/docs/extensions.md";
/**
...
/**
 * Migrate sessions from ~/.hamr/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.hamr/agent/ instead of
 * ~/.hamr/agent/sessions/<encoded-cwd>/. This migration moves them
