...
Play DOOM as an overlay in hamr. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
hamr --extension ./examples/extensions/doom-overlay
```
...
- [hamr-doom](https://github.com/badlogic/hamr-doom) for the original hamr integration
