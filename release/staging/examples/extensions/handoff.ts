...
import { complete, type Message } from "@hamr/ai";
import type { ExtensionAPI, SessionEntry } from "@hamr/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@hamr/coding-agent";
