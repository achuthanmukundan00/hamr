...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@hamr/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@hamr/tui";
