...
This document maps the Hamr runtime architecture: the components that form the agent's core execution, observability, and recovery surfaces. It covers **current state**, not planned features. Components marked as `[in-progress]` or `[planned]` are called out explicitly.

For implementation details, see the [specs directory](https://github.com/skaft/hamr/tree/main/specs). Links to source files are at the top of each section.
...
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| Session                | [`src/session/Session.ts`](https://github.com/skaft/hamr/blob/main/src/session/Session.ts)                                     | **active** |
| ActionExecutor         | [`src/actions/ActionExecutor.ts`](https://github.com/skaft/hamr/blob/main/src/actions/ActionExecutor.ts)                       | **active** |
| ExecutionEnv           | [`src/env/ExecutionEnv.ts`](https://github.com/skaft/hamr/blob/main/src/env/ExecutionEnv.ts)                                   | **active** |
| Provider Factory       | [`src/llm/provider-factory.ts`](https://github.com/skaft/hamr/blob/main/src/llm/provider-factory.ts)                           | **active** |
| Parser Pipeline        | [`src/llm/parsers/`](https://github.com/skaft/hamr/tree/main/src/llm/parsers)                                                  | **active** |
| Parser Repair          | [`src/llm/repair/`](https://github.com/skaft/hamr/tree/main/src/llm/repair)                                                    | **active** |
| RecoveryManager        | [`src/recovery/RecoveryManager.ts`](https://github.com/skaft/hamr/blob/main/src/recovery/RecoveryManager.ts)                   | **active** |
| Context Budget         | [`src/agent/context-budget.ts`](https://github.com/skaft/hamr/blob/main/src/agent/context-budget.ts)                           | **active** |
| Message Assembly       | [`src/session/message-assembly.ts`](https://github.com/skaft/hamr/blob/main/src/session/message-assembly.ts)                   | **active** |
| DeterministicCompactor | [`src/compaction/DeterministicCompactor.ts`](https://github.com/skaft/hamr/blob/main/src/compaction/DeterministicCompactor.ts) | **active** |
| EventStore             | [`src/store/EventStore.ts`](https://github.com/skaft/hamr/blob/main/src/store/EventStore.ts)                                   | **active** |
| SpanTracer             | [`src/telemetry/SpanTracer.ts`](https://github.com/skaft/hamr/blob/main/src/telemetry/SpanTracer.ts)                           | **active** |
| TokenCounter           | [`src/metrics/TokenCounter.ts`](https://github.com/skaft/hamr/blob/main/src/metrics/TokenCounter.ts)                           | **active** |
| CostTracker            | [`src/metrics/CostTracker.ts`](https://github.com/skaft/hamr/blob/main/src/metrics/CostTracker.ts)                             | **active** |
| Structured Logging     | [`src/logging/`](https://github.com/skaft/hamr/tree/main/src/logging)                                                          | **active** |
| EventBus               | [`src/events/EventBus.ts`](https://github.com/skaft/hamr/blob/main/src/events/EventBus.ts)                                     | **active** |
| inspect metrics        | [`src/commands/inspect-metrics.ts`](https://github.com/skaft/hamr/blob/main/src/commands/inspect-metrics.ts)                   | **active** |

---

## 1. Session

**Source:** [`src/session/Session.ts`](https://github.com/skaft/hamr/blob/main/src/session/Session.ts)
**Spec:** [`specs/001-session-extraction.md`](https://github.com/skaft/hamr/blob/main/specs/001-session-extraction.md)
...
- **`createConversation()`** — static factory for a fresh conversation with the Hamr system prompt and optional skill messages.
...
> ⚠️ **DO NOT touch casually:** The turn loop (`startTurn`) is the single most critical path in Hamr. Changes here affect budget enforcement, tool-call/tool-result protocol integrity, verification, steering, recovery, and handoff. Any modification must be tested against the full test suite.

---

## 2. ActionExecutor

**Source:** [`src/actions/ActionExecutor.ts`](https://github.com/skaft/hamr/blob/main/src/actions/ActionExecutor.ts)
**Spec:** [`specs/002-action-executor.md`](https://github.com/skaft/hamr/blob/main/specs/002-action-executor.md)
...
**Source:** [`src/env/ExecutionEnv.ts`](https://github.com/skaft/hamr/blob/main/src/env/ExecutionEnv.ts), [`src/env/NodeExecutionEnv.ts`](https://github.com/skaft/hamr/blob/main/src/env/NodeExecutionEnv.ts)
**Spec:** [`specs/003-execution-env.md`](https://github.com/skaft/hamr/blob/main/specs/003-execution-env.md)
...
**Source:** [`src/llm/provider-factory.ts`](https://github.com/skaft/hamr/blob/main/src/llm/provider-factory.ts)
...
**Sources:** [`src/llm/parsers/`](https://github.com/skaft/hamr/tree/main/src/llm/parsers), [`src/llm/repair/`](https://github.com/skaft/hamr/tree/main/src/llm/repair)
**Spec:** [`specs/011-parser-repair.md`](https://github.com/skaft/hamr/blob/main/specs/011-parser-repair.md)

Hamr's parser pipeline handles the reality that local models frequently produce malformed tool calls, leaked reasoning tags, truncated JSON, and broken XML. The pipeline sanitizes, repairs, and parses model output before it reaches the tool execution stage.
...
**Source:** [`src/recovery/RecoveryManager.ts`](https://github.com/skaft/hamr/blob/main/src/recovery/RecoveryManager.ts)
**Spec:** [`specs/010-recovery-recipes.md`](https://github.com/skaft/hamr/blob/main/specs/010-recovery-recipes.md)
...
**Source:** [`src/agent/context-budget.ts`](https://github.com/skaft/hamr/blob/main/src/agent/context-budget.ts), [`src/compaction/DeterministicCompactor.ts`](https://github.com/skaft/hamr/blob/main/src/compaction/DeterministicCompactor.ts)
**Spec:** [`specs/008-context-strategy.md`](https://github.com/skaft/hamr/blob/main/specs/008-context-strategy.md), [`specs/009-deterministic-compaction.md`](https://github.com/skaft/hamr/blob/main/specs/009-deterministic-compaction.md)
...
When estimated tokens exceed the effective input limit, Hamr applies compaction in stages — each progressively more aggressive:
...
**Source:** [`src/store/EventStore.ts`](https://github.com/skaft/hamr/blob/main/src/store/EventStore.ts)
**Spec:** [`specs/005-event-store.md`](https://github.com/skaft/hamr/blob/main/specs/005-event-store.md)

SQLite-backed append-only event log stored at `~/.local/share/hamr/history.db`. The store is **optional** — Hamr runs without it when SQLite is unavailable.
...
**Default path:** `~/.local/share/hamr/history.db`

---

## 9. SpanTracer

**Source:** [`src/telemetry/SpanTracer.ts`](https://github.com/skaft/hamr/blob/main/src/telemetry/SpanTracer.ts)
**Spec:** [`specs/006-span-tracing.md`](https://github.com/skaft/hamr/blob/main/specs/006-span-tracing.md)
...
**Sources:** [`src/metrics/TokenCounter.ts`](https://github.com/skaft/hamr/blob/main/src/metrics/TokenCounter.ts), [`src/metrics/CostTracker.ts`](https://github.com/skaft/hamr/blob/main/src/metrics/CostTracker.ts)
**Spec:** [`specs/017-token-metrics.md`](https://github.com/skaft/hamr/blob/main/specs/017-token-metrics.md)
...
**Source:** [`src/logging/`](https://github.com/skaft/hamr/tree/main/src/logging)
...
**Source:** [`src/events/EventBus.ts`](https://github.com/skaft/hamr/blob/main/src/events/EventBus.ts)
**Spec:** [`specs/004-event-bus.md`](https://github.com/skaft/hamr/blob/main/specs/004-event-bus.md)
...
**Source:** [`src/commands/inspect-metrics.ts`](https://github.com/skaft/hamr/blob/main/src/commands/inspect-metrics.ts)

CLI command accessible via `hamr inspect --metrics`. Three modes:

| Command                                  | Output                          |
| ---------------------------------------- | ------------------------------- |
| `hamr inspect --metrics`                | Recent sessions table (last 20) |
| `hamr inspect --metrics --session <id>` | Event timeline for a session    |
| `hamr inspect --metrics --stats`        | Aggregate statistics (30 days)  |
...
See [`src/handoff/HandoffManager.ts`](https://github.com/skaft/hamr/blob/main/src/handoff/HandoffManager.ts) and [`specs/014-handoff-sub-agents.md`](https://github.com/skaft/hamr/blob/main/specs/014-handoff-sub-agents.md).
...
| Spec                                                                                                                                   | Topic                           |
| -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| [`specs/001-session-extraction.md`](https://github.com/skaft/hamr/blob/main/specs/001-session-extraction.md)             | Session extraction from Session |
| [`specs/002-action-executor.md`](https://github.com/skaft/hamr/blob/main/specs/002-action-executor.md)                   | ActionExecutor                  |
| [`specs/003-execution-env.md`](https://github.com/skaft/hamr/blob/main/specs/003-execution-env.md)                       | ExecutionEnv                    |
| [`specs/004-event-bus.md`](https://github.com/skaft/hamr/blob/main/specs/004-event-bus.md)                               | EventBus                        |
| [`specs/005-event-store.md`](https://github.com/skaft/hamr/blob/main/specs/005-event-store.md)                           | EventStore                      |
| [`specs/006-span-tracing.md`](https://github.com/skaft/hamr/blob/main/specs/006-span-tracing.md)                         | SpanTracer                      |
| [`specs/008-context-strategy.md`](https://github.com/skaft/hamr/blob/main/specs/008-context-strategy.md)                 | Context strategy                |
| [`specs/009-deterministic-compaction.md`](https://github.com/skaft/hamr/blob/main/specs/009-deterministic-compaction.md) | Deterministic compaction        |
| [`specs/010-recovery-recipes.md`](https://github.com/skaft/hamr/blob/main/specs/010-recovery-recipes.md)                 | Recovery recipes                |
| [`specs/011-parser-repair.md`](https://github.com/skaft/hamr/blob/main/specs/011-parser-repair.md)                       | Parser repair                   |
| [`specs/014-handoff-sub-agents.md`](https://github.com/skaft/hamr/blob/main/specs/014-handoff-sub-agents.md)             | Handoff / sub-agents            |
| [`specs/016-structured-logging.md`](https://github.com/skaft/hamr/blob/main/specs/016-structured-logging.md)             | Structured logging              |
| [`specs/017-token-metrics.md`](https://github.com/skaft/hamr/blob/main/specs/017-token-metrics.md)                       | Token / cost metrics            |
