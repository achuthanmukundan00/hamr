...
Hamr supports MCP (Model Context Protocol) servers for extending tool capabilities.
...
| --------- | -------- | ------------------ | -------------------------------------------- |
| `enabled` | boolean  | No (default: true) | Whether the server starts with Hamr         |
...
This gives Hamr access to up-to-date library documentation during coding tasks.

## Validation

Hamr validates MCP configurations:
